...
<ul class="nav nav-pills nav-stacked">
  <ul class="dropdown">
   <li><a class="active" onclick="location.href = '#home'">Solicitudes Comunitarias Anterior</a></li>
 <li class="dropdown-content">
    <a onclick="location.href = '../mant_repersonal/registro.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t']=$io;?>'">Mantenedor Registro Personal</a>
    
    <a onclick="location.href = '../mant_sectores/sectores.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t1']=$io;?>'">Mantenedor Sectores</a>
    
    <a onclick="location.href = '../mant_tiporganizacion/organizacion.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t2']=$io;?>'">Mantenedor Tipos Organizaciones</a>
    
    <a onclick="location.href = '../registro_admin/registro.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t5']=$io;?>'">Registro Organizaciones Comunitarias</a>
    
    <a onclick="location.href = '../historial_registro_org/historial_org.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t3']=$io;?>'">Historial Organizaciones Comunitarias</a>
    
    <a onclick="location.href = '../solicitud_admin/registro_solicitud.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t6']=$io;?>'">Solicitudes Comunitarias</a>
    
    <a onclick="location.href = '../historial_solicitudes/historial_sol.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t4']=$io;?>'">Historial Solicitudes</a>
    
    <a onclick="location.href = '../historial_solicitudes_anterior/historial_sol.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t8']=$io;?>'">Historial Solicitudes Anteriores</a>
    
    <a onclick="location.href = '../historial_sesiones/historial_org.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t9']=$io;?>'">Historial Inicio Sesión</a>
...
<p class= "titulo2" align="center"> Solicitudes Comunitarias Anteriores</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p class= "titulo3">Geolocalizacion:  </p>
 <iframe id="cont" class="cont" onmouseleave="coordenadas();" oncopy="return false" onpaste="return false" oncontextmenu="return false" src="googlemaps.html" frameborder="0" style="border:0" allowfullscreen ></iframe>
<input type="text" class="coords" id="coords" name="coords" style="text-align:center" placeholder="Buscar direccion y arrastrar marcador..." size="30"  maxlength="280"  autocomplete="off"/>  <input type="text" class="coords2" id="coords2" name="coords2" style="text-align:center" placeholder="Buscar direccion y arrastrar marcador..." size="30" maxlength="280"  autocomplete="off"/>  </p>
...
<!--sectores -->
<p>&nbsp;</p>
<input type="submit" onclick="buscar();" id="gu" class="g" name="gu" value="Guardar" onclick="valores_ll();"/>
</form>
</p>
<p>
<?php
$var = "";
  if(isset($_POST["gu"])){
       ...
       if ($obse == ""){
            ejecutarSQLCommand("Call Ingresar_Solicitud_Antigua ('$suma','$fechainicio','0000-00-00','$orga','$direccion','$sector','$descripcion','$tipo','$latitud','$longitud','$est','$fecha','$fecha2','---')");
		echo "<script>alert('Datos ingresados correctamente')</script>";
        }else{
        ejecutarSQLCommand("Call Ingresar_Solicitud_Antigua ('$suma','$fechainicio','0000-00-00','$orga','$direccion','$sector','$descripcion','$tipo','$latitud','$longitud','$est','$fecha','$fecha2','$obse')");
		echo "<script>alert('Datos ingresados correctamente')</script>";    
        }
