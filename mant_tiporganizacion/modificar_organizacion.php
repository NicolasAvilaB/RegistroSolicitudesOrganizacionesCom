...
<style type="text/css">
@import url("modificar_organizacion.css");
</style>
<link href="modificar_organizacion.css" rel="stylesheet" type="text/css">
...
<ul class="nav nav-pills nav-stacked">
  <li><a onclick="location.href = 'organizacion.php'">Mantenedor Tipo Organizaciones</a></li>
...
$conexion = mysqli_connect("localhost","cre37351_root","lacomunagana","cre37351_deptosocial") or die ("Error");
    ...
    if(isset($_GET["modificar"])){
        ...
        $ejecutar = mysqli_query($conexion, "Call Buscar_ID_Tipo_Org('".$editar_id."')");
...
<form id="form1" name="form1" action="modificar_organizacion.php" method="POST" onSubmit="return validar(this)">
<p class= "titulo2" align="center"> Modificar Tipo Organizaciones</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<p class= "titulo3">Organizaciones: <input type="text" class="org" id="org" name="org" style="text-align:center" placeholder="Ingrese Nombre Usuario..." size="30"  onkeypress="return valida_letras(event)" maxlength="90" autocomplete="off" value="<?php echo $a; ?>"/> </p>
...
if(isset($_POST["gu"])){
    ...
    $doc = $_POST["id"];
	ejecutarSQLCommand("Call Modificar_Organizacion('$org','$doc')");
