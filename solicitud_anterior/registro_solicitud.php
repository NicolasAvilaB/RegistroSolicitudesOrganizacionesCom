...
<ul class="nav nav-pills nav-stacked">
    ...
    <a onclick="location.href = '../historial_solicitudes_operario/historial_sol.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['is3']=$io;?>'"> Historial Solicitudes</a>
