...
function validar(Formulario){
	...
	return false;
     ...
     if (document.form1.telefono.value.length < 9){
    	...
    	else if(document.form1.stelefono.value==0){
           	alert("Advertencia: Identifique al 1° Usuario de telefono");
        	document.form1.stelefono.focus();
        	return false;
    	}
     ...
     if (document.form1.telefono2.value.length < 9){
    	...
    	else if(document.form1.s2telefono.value==0){
           	alert("Advertencia: Identifique al 2° Usuario de telefono");
        	document.form1.s2telefono.focus();
        	return false;
    	}
    	else if(document.form1.fecha.value==0){
           	alert("Advertencia: Ingrese Fecha de Organizacion");
    	...
    	else if(document.form1.s3telefono.value==0){
           	alert("Advertencia: Identifique al 3° Usuario de telefono");
        	document.form1.s3telefono.focus();
        	return false;
    	}
    	else if(document.form1.fecha.value==0){
           	alert("Advertencia: Ingrese Fecha de Organizacion");
	...
	else if(document.form1.telefono4.value.length > 0){
        if (document.form1.telefono4.value.length < 9){
   	        alert("Advertencia: Minimo de Numero del 4° Telefono requerido es de 9 digitos");
        	document.form1.telefono4.focus();
        	return false; 
        }
        else if(document.form1.se4.value==0){
           	alert("Advertencia: Seleccione por lo menos un propietario para el 4° telefono");
        	document.form1.se4.focus();
        	return false;
    	}
    	else if(document.form1.s4telefono.value==0){
           	alert("Advertencia: Identifique al 4° Usuario de telefono");
        	document.form1.s4telefono.focus();
        	return false;
    	}
    	else if(document.form1.fecha.value==0){
           	alert("Advertencia: Ingrese Fecha de Organizacion");
	...
	else if(document.form1.telefono5.value.length > 0){
        if (document.form1.telefono5.value.length < 9){
   	        alert("Advertencia: Minimo de Numero del 5° Telefono requerido es de 9 digitos");
        	document.form1.telefono5.focus();
        	return false; 
        }
        else if(document.form1.se5.value==0){
           	alert("Advertencia: Seleccione por lo menos un propietario para el 5° telefono");
        	document.form1.se4.focus();
        	return false;
    	}
    	else if(document.form1.s5telefono.value==0){
           	alert("Advertencia: Identifique al 5° Usuario de telefono");
        	document.form1.s5telefono.focus();
        	return false;
    	}
    	else if(document.form1.fecha.value==0){
           	alert("Advertencia: Ingrese Fecha de Organizacion");
