...
$busqueda = $_GET["valor"];
$result_markers = "Call Buscar_AnteriorSoli('".$busqueda."%')";
...
while ($row_markers = mysqli_fetch_assoc($resultado_markers)){
  ...
  echo '<marker ';
 echo 'name="Organizacion: ' . parseToXML($row_markers['Organizacion']) . ', Sector: ' . parseToXML($row_markers['Sector']) . ', Direccion: '. parseToXML($row_markers['Direccion']) . '" ';
