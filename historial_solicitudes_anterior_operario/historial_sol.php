...
<ul class="nav nav-pills nav-stacked">
  ...
  <li class="dropdown-content">
    ...
    <a onclick="location.href = '../historial_registro_org_operario/historial_org.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['is1']=$lñ;?>'">Historial Organizaciones Comunitarias</a>
    ...
    <a onclick="location.href = '../historial_solicitudes_operario/historial_sol.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['is3']=$lñ;?>'"> Historial Solicitudes</a>
    <a onclick="location.href = '../solicitud_anterior/registro_solicitud.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['is4']=$lñ;?>'">Solicitudes Comunitarias Anteriores</a>
  </li>
    <li><a class="active" onclick="location.href = '#home'">Historial Solicitudes Anteriores</a></li>
  </ul>
  <li><a onclick="location.href = '../menu.php'">Volver al Menu</a></li>
</ul>
</div>
<section>
<p class= "titulo2" align="center"> Historial Solicitudes Anteriores</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<table class="tabla" border="2" style="background-color: #F9F9F9;">
    ...
    <tr>
     ...
     $dato = $_POST['bus'];
        ...
        $consulta = "Call Buscar_AnteriorSoli('".$dato."%')";
...
$("table").tableExport({
	...
	fileName: "Historial Solicitudes Comunitarias Anteriores",    //Nombre del archivo 
});
</script>
</head>
</html>