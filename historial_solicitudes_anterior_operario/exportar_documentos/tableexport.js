...
;(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function createObjButton(dataObject, myContent, myClass) {
                    var exportButton = "<button data-fileblob='" + dataObject + "' class='boton_exportacion' id='boton_exportacion'> <span class='tooltipexcel'>Descargar Tabla a Excel</span>" + myContent + "</button>";
        ...
        TableExport.prototype = {
            ...
            xlsx: {
                defaultClass: "xlsx",
                buttonContent: "<img class='excel' src='../Imagenes/excel.png'>",
            ...
            xls: {
                defaultClass: "xls",
       buttonContent: "<img class='excel' src='../Imagenes/excel.png'>",          separator: "\t",
