...
function eliminar_user(dato){
     if (confirm("Advertencia: ¿Desea eliminar esta solicitud?, se informaran a todos los correos registrados en el sistema")) {
        location.href = "historial_sol.php?eliminar="+dato;
     } else {
        return false;
     }
}
...
function validar(Formulario){
	if(document.form1.estado.value==0){
   	alert("Advertencia: Campo Estado esta vacio");
	document.form1.estado.focus();
	return false;
	}
	else if(document.form1.fecha.value==0){
   	alert("Advertencia: Campo Fecha esta vacio");
	document.form1.fecha.focus();
	return false;
	}
	else if(document.form1.obse.value==0){
   	alert("Advertencia: Campo Observacion esta vacio");
	document.form1.obse.focus();
	return false;
	}
	else {
	return true;
