...
function validar(Formulario){
	...
	return false;
   	...
   	alert("Advertencia: No se describió una coordenada");
	document.form1.coords.focus();
	return false;
	}
	...
	return false;
      ...
      if (confirm("Advertencia: No se han agregado correos electronicos externos, La solicitud solo se enviara a los correos electronicos registrados en el sistema, ¿Desea continuar?")) {
        return true; 
      } else {
        return false;
      }
...
{ 
    if (a == 60){
        ...
        o.className="corr";
        o.autocomplete="off";
        o.placeholder="Ingrese Correo Electronico a Enviar Solicitud...";
        document.getElementById('correo_electronico').appendChild(o);
        document.getElementById("contador").textContent = a;
        if (a==1){
            var botonquitar = document.getElementById('btn_quitar');
            botonquitar.style.visibility = 'visible';
        }
    }
}
function quitar() 
{ 
    var os = document.getElementById('corr'+a);
    document.getElementById('correo_electronico').removeChild(os);
    a = a - 1;
    document.getElementById("contador").textContent = a;
    if (a==0){
        var botonquitar = document.getElementById('btn_quitar');
        botonquitar.style.visibility = 'hidden';
    }
}
