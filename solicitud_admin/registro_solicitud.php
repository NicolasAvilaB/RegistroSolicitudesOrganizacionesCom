...
<ul class="nav nav-pills nav-stacked">
 ...
 <li class="dropdown-content">
    ...
    <a onclick="location.href = '../solicitud_admin_anterior/registro_solicitud.php<?php SESSION_START(); $_SESSION['usua']=$n; $_SESSION['cla']=$c; $_SESSION['t7']=$io;?>'">Solicitudes Comunitarias Anteriores</a>
