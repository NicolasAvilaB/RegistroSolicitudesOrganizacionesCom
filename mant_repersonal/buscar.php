...
mysqli_set_charset($conexion,"utf8");
	$consulta = mysqli_query($conexion, "Call Consulta_Nombre_Admin('$consultaBusqueda')");
mysqli_set_charset($consulta,"utf8");
	...
	if ($filas === 0) {
		...
		<script> nombre.setCustomValidity('');</script>
</p>";
        ...
        $mensaje .= '
			...
			<script> nombre.setCustomValidity("Nombre ya se encuentra registrado");</script>
			</p>';
	}; //Fin else $filas
