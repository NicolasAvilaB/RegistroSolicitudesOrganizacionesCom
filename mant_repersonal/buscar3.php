...
mysqli_set_charset($conexion,"utf8");
	$consulta = mysqli_query($conexion, "Call Consultar_Email_Admin('$consultaBusqueda')");
mysqli_set_charset($consulta,"utf8");
	...
	if ($filas === 0) {
		...
		<script> rut.setCustomValidity('');</script>
</p>";
        ...
        $mensaje .= '
			...
			<script> rut.setCustomValidity("Email ya se encuentra registrado");</script>
			</p>';
	}; //Fin else $filas
