...
mysqli_set_charset($conexion,"utf8");
	$consulta = mysqli_query($conexion, "Call Consulta_Clave_Admin('$consultaBusqueda')");
mysqli_set_charset($consulta,"utf8");
	...
	if ($filas === 0) {
		...
		<script> clave.setCustomValidity('');</script>
</p>";
        ...
        $mensaje .= '
			...
			<script> clave.setCustomValidity("Clave ya se encuentra registrado");</script>
			</p>';
	}; //Fin else $filas
