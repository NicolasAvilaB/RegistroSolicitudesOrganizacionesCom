     ...
     $dato = $_POST['bus'];
       ...
       ?>
           <tr class="objetos">
            ...
            <td><?php echo $c13; ?></td>
            <td><?php echo $c14; ?></td>
            <!--<td><a class="modificar_usuario" href="modificar_solicitud.php?modificar=<?php echo $c1; ?>">Modificar</a></td>
            <td><a class="eliminar_usuario" href="historial_sol.php?eliminar=<?php echo $c1; ?>">Eliminar</a></td>-->
            </tr>
   <?php } }?>
</table>
</div>
...
$conexion = mysqli_connect("localhost","cre37351_root","lacomunagana","cre37351_deptosocial") or die ("Error");
 mysqli_set_charset($conexion,"utf8");
    if(isset($_GET["eliminar"])){
	    ...
	    $ejecutar2 = mysqli_query($conexion, "Call Borrar_Solicitud_Anterior('".$recuperacion_id."')");
        if($ejecutar2){
